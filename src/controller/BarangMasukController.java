...
public class BarangMasukController {
        ...
        if (conn != null) {
            try {
                ...
                while (resultSet.next()) {
                    ...
                    try {
                        inputDate = inputDateFormat.parse(resultSet.getString("tanggal_masuk"));
                    } catch (ParseException e) {
                        System.err.println("Error parsing date: " + e.getMessage());
                    }

                   data.id = resultSet.getInt("id_masuk"); 
                   ...
                   data.jumlah = resultSet.getInt("jumlah_masuk"); 
                ...
                Logger.getLogger(BarangMasukController.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        
        inventory.barangMasuk.setTable(dataList);
    }
    ...
    public void addData(Transaksi data) {
        ...
        if (conn != null) {
            try {
                String query = "INSERT INTO masuk (id_barang, jumlah_masuk, tanggal_masuk) VALUES (?, ?, ?)";
    ...
    public void deleteData(int id) {
         ...
         if (conn != null) {
             try {
                String query = "DELETE FROM masuk \n" +
                                        "WHERE id_masuk = ?";
    ...
    public void getDataBarang() {
        ...
        inventory.formBrgMasuk.setBarang(dataList);
    }
}
